...
export class NystDecisionWebhookWorker {
  ...
  async runOne():Promise<boolean>{
    ...
    try{
      ...
      const headers={"content-type":"application/json","content-length":String(Buffer.byteLength(body)),"user-agent":"Nyst-Decision-Webhook/0.2.2","x-nyst-event-id":eventId,"x-nyst-timestamp":timestamp,"x-nyst-signature":signWebhook(secret,timestamp,body,eventId)};
